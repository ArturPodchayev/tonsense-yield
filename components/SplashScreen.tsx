...
export function SplashScreen({ onDismiss }: SplashScreenProps) {
  ...
  useEffect(() => {
    if (wallet && !hadWalletOnMount.current && !dismissed.current) {
      dismissed.current = true;
      setConnected(true);
      setTimeout(() => triggerDismiss(), 1200);
    }
  }, [wallet]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="splash-in"
          style={{ "--delay": "0.5s", marginBottom: "28px" } as React.CSSProperties}
        >
          <div
        ...
        <div
          className="splash-in"
          style={{ "--delay": "1.5s", marginBottom: "10px" } as React.CSSProperties}
        >
          <h1
            style={{
          ...
          >
            TonSense{" "}
            <span style={{ color: "#00E090" }}>Yield</span>
          </h1>
        </div>
        ...
        <div
          className="splash-in"
          style={{ "--delay": "2.0s", marginBottom: "36px" } as React.CSSProperties}
        >
        ...
        <div style={{ marginBottom: "32px", padding: "0 32px" }}>
          <div
            ...
            style={{
              height: 1,
              background:
                "linear-gradient(90deg, transparent, rgba(0,152,234,0.55), rgba(0,212,170,0.4), transparent)",
            }}
          />
        </div>
        ...
        >
          {PILLS.map((pill, i) => (
            ...
            >
              ...
              <span style={{ color: "#D8E4F0", fontSize: "0.9rem", fontWeight: 500 }}>
                {pill.text}
              </span>
            </div>
          ))}
          ...
          {connected ? (
            <div
              style={{
                ...
                border: "1px solid rgba(0,224,144,0.4)",
                color: "#00E090",
                fontSize: "1rem",
                fontWeight: 600,
              }}
